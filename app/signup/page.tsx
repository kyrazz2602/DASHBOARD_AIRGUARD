      ...
      <div className="w-full max-w-md animate-in fade-in zoom-in duration-500 slide-in-from-bottom-4 my-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-sm">
            Create an account to Monitoring air quality
          </p>
        </div>
        ...
        <div className="bg-card rounded-2xl border border-border shadow-xl p-8 backdrop-blur-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 mt-4">
            ...
            <button
              type="submit"
              disabled={isLoading || isGoogleLoading}
              className="w-full mt-6 py-3 bg-primary text-primary-foreground font-semibold rounded-lg hover:bg-primary/90 shadow-md hover:shadow-lg transition-all disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2 active:scale-[0.98] min-h-[44px]"
            >
              {isLoading ? (
                <>
